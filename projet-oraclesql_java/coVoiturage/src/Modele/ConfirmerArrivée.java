...
public class ConfirmerArrivée implements JDBC{
	private String id_tronçon;
	private String id_trajet;
	public ConfirmerArrivée(String id_tronçon, String id_trajet) {
    ...
    public void appelJDBC() {
        ...
        try {
                ...
                String SQL="UPDATE Tronçon set etat_tronçon_conducteur= 'Arrivee' "
