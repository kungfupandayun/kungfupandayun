...
public class ConfirmerDépart implements JDBC{
	private String id_tronçon;
	private String id_trajet;
	public ConfirmerDépart(String id_tronçon, String id_trajet) {
    ...
    public void appelJDBC() {
        ...
        try {
                ...
                String SQL="UPDATE Tronçon set etat_tronçon_conducteur= 'Depart' "
                ...
                System.err.println("[ConfirmerDépart]La confirmation du départ du tronçon n'est pas enregistrée");
                e.printStackTrace();
        }
	}
}
