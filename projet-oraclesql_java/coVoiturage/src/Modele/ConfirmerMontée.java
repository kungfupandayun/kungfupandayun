...
public class ConfirmerMontée implements JDBC{
	private String id_tronçon;
	private String id_trajet;
	private String id_parcours;
	public ConfirmerMontée(String id_tronçon,String id_trajet,String id_parcours) {
    ...
    public void appelJDBC() {
        ...
        try {
                ...
                String SQL="UPDATE ParcoursTronçon set etat_tronçon_passenger= 'Montee' "
                ...
                System.err.println("[ConfirmerMontée]La confirmation de montée du tronçon n'est pas enregistrée");
                e.printStackTrace();
        }
	}
}
